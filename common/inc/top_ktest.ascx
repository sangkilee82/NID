<%@ Control Language="C#" AutoEventWireup="true" CodeFile="top_ktest.ascx.cs" Inherits="zadmin_common_inc_top" %>
				...
				<div class="util_section fix">
					...
					<ul class="lft_spon_ul fix">
						<li><a href="http://www.mohw.go.kr/" target="_blank" rel="noopener noreferrer" title="새창으로 열기">
							<img src="../images/common/img_bb.gif" alt="보건복지부" style="width:100px;"/></a></li>
							<li style="width:135px;"><a href="https://www.nmc.or.kr/main.asp" target="_blank" rel="noopener noreferrer" title="새창으로 열기" >
						...
						<asp:Repeater runat="server" ID="top_RT" OnItemDataBound="TopBounds">
							<ItemTemplate>
								<li class="oneDepth" id="depth1_item" runat="server">
									<a href="javascript:void(0)"><%# Eval( "CODE_NAME" ).ConString().Replace("<br/>","") %></a>
