            ...
            <div class="header_section">
                ...
                <div class="util_section fix">
                    ...
                    <ul class="ctn_login_ul fix">
                        ...
                        <li>
                            <a href="https://www.facebook.com/nidinfo" target="_blank" rel="noopener noreferrer" title="새창으로 열기">
                                <img src="../images/common/ico_sns4.gif" alt="페이스북" /></a>
                            <a href="http://www.youtube.com/user/NIDPARTNER" target="_blank" rel="noopener noreferrer" title="새창으로 열기">
                                <img src="../images/common/ico_sns2.gif" alt="유튜브" /></a>
                            <a href="https://twitter.com/nid_info" target="_blank" rel="noopener noreferrer" title="새창으로 열기">
                                <img src="../images/common/ico_sns3.gif" alt="트위터" /></a>
                            <a href="https://www.instagram.com/nid_kr/" target="_blank" rel="noopener noreferrer" title="새창으로 열기">
                                <img src="../images/common/ico_sns5.gif" alt="인스타그램" /></a>
                        </li>
                    </ul>
                ...
                <div class="header_tit_section">
                    ...
                    <div class="skip">치매로부터 가장 먼저 자유로워지는 나라, 중앙치매센터가 만들어 가겠습니다.</div>
                </div>
                <!--/header_tit_section-->
                        ...
                        <asp:Repeater runat="server" ID="top_RT" OnItemDataBound="TopBounds">
                            <ItemTemplate>
                                <li class="oneDepth" id="depth1_item" runat="server">
                                    <a href="javascript:void(0)" <asp:Literal runat="server" ID="edu_html"/>>
                                        <%# Eval( "CODE_NAME" ).ConString().Replace("<br/>","") %>
                                    </a>
