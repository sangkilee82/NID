...
public partial class zadmin_common_inc_top : UserControlBase {
    ...
    protected void Page_Load(object sender, EventArgs e) {
        ...
        // 2021.01.18 - 홈페이지 다운 이슈때문에 임시로 주석처리 - 허양민
        //VisitCount();
    ...
    private void SetMatchCode() {
        ...
        using (SqlConnection conn = new SqlConnection(Base.commDBString)) {
            ...
            if (matchCode.IsEmpty()) {
                ...
                } else if (Request.Path.IndexOf("_stest.aspx") != 1) {
    ...
    protected void TopBounds(object sender, RepeaterItemEventArgs e) {
        ...
        if (e.Item.ItemType == ListItemType.AlternatingItem || e.Item.ItemType == ListItemType.Item) {
            ...
            // 교육 클릭 시 팝업창 활성화 
            if (code == "013000000") {
                edu_html = "onclick=window.open('https://edu.nid.or.kr');"; 
                c_lt = (Literal)e.Item.FindControl("edu_html");
                c_lt.Text = edu_html;
            }
