...
function calendar_set(e) {
  ...
  if (!calendar_div) {
    ...
    document.getElementById("calendar_div_wrap").appendChild(calendar_div);
  }
  calendar_div.id = "calendar_div";
  calendar_div.style.cssText = "background-color:#ffffff; border:3px; border-style:double; border-color:#c2c2c2; z-index: 999;";
...
function calendar_draw(set_date) {
  ...
  // 년, 월, 닫기 버튼 html
  html += "<tr height=\"20\">";
  html += "<td colspan=\"6\" style=\"border: none !important; padding: 0 !important;padding-left:0 !important;text-align:center\" width=\"140px\" align=\"center\" valign=\"center;\">";
  html += "<span style=\"border:none;cursor:pointer;display:inline; font-size: 12px;\" onClick=\"calendar_draw('" + prev_y + "')\">◀</span> ";
  html += "<span style=\"border:none;font-size: 12px;display:inline; cursor:pointer;\" onClick=\"calendar_years_toggle()\">↕" + calendar_y + "</span> ";
  html += "<span style=\"border:none;cursor:pointer; font-size: 12px;display:inline;\" onClick=\"calendar_draw('" + next_y + "')\">▶</span> ";
  html += "<span style=\"border:none;cursor:pointer; font-size: 12px;display:inline;\" onClick=\"calendar_draw('" + prev_m + "')\">◀</span> ";
  html += "<span style=\"border:none;cursor:pointer; font-size: 12px;display:inline;\" onClick=\"calendar_months_toggle()\">↕" + calendar_m + "</span> ";
  html += "<span style=\"border:none;cursor:pointer; font-size: 12px;display:inline;\" onClick=\"calendar_draw('" + next_m + "')\">▶</span> ";
  html += "</td>";
  html += "<td style=\"border:none;padding:0;\" align=\"\" valign=\"center;\"><span style=\"border:none;display:inline;cursor:pointer; font-size: 12px; font-weight:bold;\" onClick=\"calendar_close()\">X</span></td>";
  html += "</tr>";
  // 요일표시 html
  html += "<tr height=\"20\">";
  html += "<td style=\"width:10%;border:none;padding:0;background-color:#f0f0f0; text-align:center; font-weight:bold; font-size:11px;\">일</td>";
  html += "<td style=\"width:10%;border:none;padding:0;background-color:#f0f0f0; text-align:center; font-weight:bold; font-size:11px;\">월</td>";
  html += "<td style=\"width:10%;border:none;padding:0;background-color:#f0f0f0; text-align:center; font-weight:bold; font-size:11px;\">화</td>";
  html += "<td style=\"width:10%;border:none;padding:0;background-color:#f0f0f0; text-align:center; font-weight:bold; font-size:11px;\">수</td>";
  html += "<td style=\"width:10%;border:none;padding:0;background-color:#f0f0f0; text-align:center; font-weight:bold; font-size:11px;\">목</td>";
  html += "<td style=\"width:10%;border:none;padding:0;background-color:#f0f0f0; text-align:center; font-weight:bold; font-size:11px;\">금</td>";
  html += "<td style=\"width:10%;border:none;padding:0;background-color:#f0f0f0; text-align:center; font-weight:bold; font-size:11px;\">토</td>";
  html += "</tr>";
  ...
  for (var i = 1; i <= max_days; i++) {
    ...
    style = "border:none;padding:0;cursor:pointer; font-size:12px; text-align:center;";
  ...
  html += "<a style=\"float:left; width:22px; height:20px; text-align:center; padding-top:2px; border:1px solid #c2c2c2; background-color:#e5e5e5; font-size:11px; cursor:pointer;\" onClick=\"calendar_draw('" + calendar_y + "01')\" onMouseOver=\"this.style.backgroundColor='#c2c2c2';\" onMouseOut=\"this.style.backgroundColor='#e5e5e5';\">1</a";
